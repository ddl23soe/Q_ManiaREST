...
?>
<a href="index.php?pag=<?php echo $pagina ?>&funcao=novo" type="button" class="btn btn-secondary mt-2 mb-4">Nova Imagem</a>
		...
		<tbody>
			...
			for($i=0; $i < @count($res); $i++){
				...
				<tr>
					...
					<td><img src="../img/galeria/<?php echo $res[$i]['imagem'] ?>" width="70"></td>
						...
						<form method="post" id="form">
							<div class="modal-body">
								...
								<div id="divImgConta" class="mt-4">
									<?php if(@$imagem != ""){ ?>
										<img src="../img/galeria/<?php echo @$imagem ?>"  width="170px" id="target">
									<?php  }else{ ?>
